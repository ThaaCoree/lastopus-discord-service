...
public class Adaptive_Body extends Skill implements SkillWithCondition {

    public static String NAME = "Adaptive Body";

    public Adaptive_Body() {
        super();
        setDescription("เมื่อใช้งาน รับสถานะ Defensive Muscle XB รอบเทิร์น ระหว่างนี้เพิ่ม DEF XA และต้านทานดีบัพที่มีระดับต่ำกว่า Basic เกือบทั้งหมด");
        setActionType("Action");
        setManaCost(5);
        setCooldown(3);
        getSkillMultiplier().put("XA",new SkillMultiplier("0.2*(1+BuffAMP)"));
