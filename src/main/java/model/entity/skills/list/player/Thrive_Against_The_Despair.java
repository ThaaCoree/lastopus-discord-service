...
public class Thrive_Against_The_Despair extends Skill {

    public static String NAME = "Thrive against the despair";

    public Thrive_Against_The_Despair() {
        super();
        setDescription("เพิ่ม VIT XA");
