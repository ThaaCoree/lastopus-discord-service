...
public class Nebula extends Skill implements SkillWithCondition {
    ...
    public Nebula() {
        super();
        setDescription("ออร่ามงกุฎสีเขียวสว่าง ปรากฎบนศีรษะของสการ์เล็ต เปลี่ยนแปลงแขนข้างถนัดของเธอให้กลายเป็นหัตถ์ปีศาจ เสริมพลังให้กับอาวุธของ Sanctum of Sorrow เปลี่ยน Divergent ให้กลายเป็น Nebula Divergent ,สกิลจะใช้ Combine Action แทน Action ปกติและ False Authority จะถูกปิดใช้งาน\n" +
                ...
                "ร่างนี้จะสามารถล่องลอยได้ และไม่สามารถรับการฟื้นฟูจากยูนิตอื่นได้ แต่การสร้างความเสียหายในระหว่างนี้จะฟื้นฟูพลังชีวิตเป็น 10% ของความเสียหายที่ทำได้ \n" +
