...
public class Blue_Comet extends Skill implements SkillWithCondition {

    public static String NAME = "Blue Comet";

    public Blue_Comet() {
        super();
        setDescription("เพิ่ม ATK ให้กับตัวเอง XA เป็นเวลา XB รอบเทิร์น");
        setActionType("Combine");
        setManaCost(5);
        setCooldown(3);
        getSkillMultiplier().put("XA",new SkillMultiplier("0.22*(1+BuffAMP)"));
...
//                , 0, 1);
    ...
    public void calculateBehavior(CombatFlow combatFlow, SkillTarget skillTarget) {
        ...
        Conditions condition = combatFlow.getDatabase().getAllConditionMap().get("Blue Comet");
    ...
    public void refreshCondition(CombatFlow combatFlow) {
        Conditions condition = new Conditions("Blue Comet");
