...
public class Divergent extends Skill implements SkillWithCondition {
    ...
    public Divergent() {
        ...
        setDescription("Maelstorm (ดาบใหญ่) : กระโดดไปข้างหน้าได้ไกลที่สุด 2 ช่องรอบตัว (ไม่นับช่องตัวเอง) พร้อมเหวี่ยงดาบแห่งโทสะกระแทกลงที่พื้น สร้างความเสียหายกายภาพ XA หน่วยพร้อมสตันเป้าหมายในระยะ 0.5 เมตรรอบตัว\n" +
                ...
                "\n" +
                "สามารถใช้งานเพื่อสร้างร่างแยกขึ้นมาใช้งานอาวุธที่เลือกแทนได้ มันจะไม่หายไปจนกว่าจะสั่งให้ทำงานหรือถูกทำลาย\n" +
                "การจะใช้งานสร้างร่างแยกได้ ผู้ใช้ต้องไม่เคยใช้งาน Action ในเทิร์นมาก่อน และหลังจากสร้างร่างแยกด้วยสกิลนี้ ในเทิร์นนั้นจะไม่สามารถใช้งาน Action ได้อีก");
