...
public class Infinity_Starfall extends Skill {

    public static String NAME = "Infinity Starfall";

    public Infinity_Starfall() {
        super();
        setDescription("สกิลนี้สามารถถูกใช้งานในเทิร์นของใครก็ได้, ใช้งาน Combined Action ทั้งหมดที่เหลืออยู่ เรียกประกายแสงออกมา XB ลูกต่อหนึ่ง Combined Action ที่สูญเสียไป\n" +
                "แต่ละลูกสร้างความเสียหายเวท XA หน่วย สามารถใช้ปัดป้องความเสียหายในเหตุการณ์ที่กำลังเกิดขึ้นได้");
        setActionType("-");
        setManaCost(14);
        setCooldown(2);
        ...
        getSkillMultiplier().put("XB",new SkillMultiplier("2*(1+CastSPD)"));
