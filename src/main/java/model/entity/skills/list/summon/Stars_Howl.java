...
public class Stars_Howl extends Skill {

    public static String NAME = "Star's Howl";

    public Stars_Howl() {
        super();
        setDescription("ร้องคำรามก้องกังวาน ยูนิตศัตรูทั้งหมดในสนามได้รับความเสียหายโดยตรง XA หน่วย และรับสถานะ Tremble XB รอบเทิร์น");
