...
public class Condensed_Striking_Light extends Skill {

    public static String NAME = "Condensed Striking Light";

    public Condensed_Striking_Light() {
        super();
        setDescription("เรียกแสงจู่โจมใส่เป้าหมาย สร้างความเสียหายเวท XA หน่วย การจู่โจมนี้ไม่สามารถถูกหลบได้ การจู่โจมนี้ทะลุยูนิต");
