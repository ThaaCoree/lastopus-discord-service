...
public class Aramus extends Skill {

    public static String NAME = "Aramus";

    public Aramus() {
        super();
        setDescription("วาง 'อรามัส' ลงสามตำแหน่งในสนาม เมื่อยูนิตศัตรูเข้าไปยังพื้นที่ส่งผล อรามัสจะระเบิดออกเป็นกระสุนเพลิง\n" +
                "สร้างความเสียหายเวทธาตุไฟ XA หน่วย จากนั้นทะลุผ่านชิ่งไปยังยูนิตศัตรูอีกหนึ่งเป้าหมาย\n" +
                "หากกระสุนเพลิงพุ่งผ่านพื้นที่ส่งผลของอรามัส ระเบิดมันด้วย");
