...
public class Uncontained_Light extends Skill {

    public static String NAME = "Uncontained Light";

    public Uncontained_Light() {
        super();
        setDescription("ยิงแสงใส่เป้าหมาย XA ครั้ง สร้างความเสียหายเวทครั้งละ XB หน่วย");
        ...
        getSkillMultiplier().put("XB",new SkillMultiplier("0.5*MATK"));
        ...
        if (!skillTarget.getTarget(0).isEmpty()) {
            ...
            sendActionEvent(combatFlow.getEventBus(),
                    ActionEvent.builder(getName(), getUser(), combatFlow.findUnit(skillTarget.getTarget(0)))
                            .effect(ActionEffectType.DAMAGE_MAGICAL, xb, (int) xa)
