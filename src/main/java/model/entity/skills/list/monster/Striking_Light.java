...
public class Striking_Light extends Skill {

    public static String NAME = "Striking Light";

    public Striking_Light() {
        super();
        setDescription("เรียกแสงจู่โจมใส่เป้าหมาย สร้างความเสียหายเวท XA หน่วย การจู่โจมนี้ไม่สามารถถูกหลบได้");
