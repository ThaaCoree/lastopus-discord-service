...
public class Wind_Barrier extends Skill {

    public static String NAME = "Wind Barrier";

    public Wind_Barrier() {
        super();
        setDescription("มอบ Debris XA หน่วยให้พันธมิตรเป้าหมาย");
        setActionType("Action");
        setManaCost(0);
        setCooldown(3);
        getSkillMultiplier().put("XA",new SkillMultiplier("4*RATK"));
        ...
        if (!skillTarget.getTarget(0).isEmpty()) {
            ...
            sendActionEvent(combatFlow.getEventBus(),
                    ActionEvent.builder(getName(), getUser(), combatFlow.findUnit(skillTarget.getTarget(0)))
                            ...
                            .addActType(ActType.CREATE_DEBRIS)
                            .build()
            );
        }
    }
