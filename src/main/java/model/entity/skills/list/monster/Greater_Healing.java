...
public class Greater_Healing extends Skill {

    public static String NAME = "High Heal";

    public Greater_Healing() {
        super();
        setDescription("ฮีลให้กับ XA เป้าหมายเป็นจำนวน XB หน่วย");
        ...
        getSkillMultiplier().put("XB",new SkillMultiplier("3*MATK"));
