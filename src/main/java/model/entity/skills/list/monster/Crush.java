...
public class Crush extends Skill {
    ...
    public static String NAME = "Crush";

    public Crush() {
        super();
        setDescription("บีบรัดตัวเป้าหมาย สร้างความเสียหายกายภาพ XA หน่วย\n" +
                "เป้าหมายทำการ Vit Check, หากต่ำกว่า 90, รับ Stun 1 รอบเทิร์นด้วย");
