...
public class Piercing_Nails extends Skill {

    public static String NAME = "Piercing Nails";

    public Piercing_Nails() {
        super();
        setDescription("ใช้เล็บแทงไปที่เป้าหมาย สร้างความเสียหายกายภาพ XA หน่วยโดยคำนวณ PDEF ครึ่งเดียว");
