...
public class Tail_Pierce extends Skill {

    public static String NAME = "Tail Pierce";

    public Tail_Pierce() {
        super();
        setDescription("ใช้ได้งานเมื่อมีเป้าหมายที่ลอยอยู่กลางอากาศ\n" +
                "ใช้หางพุ่งเข้าไปแทงยังเป้าหมาย สร้างความเสียหายกายภาพ XA หน่วย\n" +
                "หากเป้าหมายมี Speed น้อยกว่าผู้ใช้ สกิลนี้จะเกิดก่อนการกระทำของเป้าหมาย");
