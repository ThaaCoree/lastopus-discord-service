...
public class Pinning_Bolt extends Skill {

    public static String NAME = "Pinning Bolt";

    public Pinning_Bolt() {
        super();
        setDescription("ยิงกระสุนจากหน้าไม้ใส่เป้าหมาย สร้างความเสียหายกายภาพ XA หน่วย\n" +
                "หากเป้าหมายกำลังอยู่กลางอากาศ ยูนิตเป้าหมายที่มี VIT น้อยกว่า 120 หน่วยจะลอยไปกับกระสุนหน้าไม้และติดเข้ากับกำแพง สร้างความเสียหายกายภาพอีก XA หน่วย");
