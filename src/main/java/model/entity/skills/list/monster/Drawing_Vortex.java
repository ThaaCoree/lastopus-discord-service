...
public class Drawing_Vortex extends Skill {

    public static String NAME = "Drawing Vortex";

    public Drawing_Vortex() {
        super();
        setDescription("เลือกเป้าหมายหนึ่งยูนิตที่สามารถมองเห็นได้ สร้างรูปร่างรูปแบบน้ำวนที่หมุนเป็นเกลียวไปมา ดึงดูดให้เป้าหมายเคลื่อนที่เข้ามาหาอย่างช้าๆ");
