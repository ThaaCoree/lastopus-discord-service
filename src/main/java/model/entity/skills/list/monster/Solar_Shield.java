...
public class Solar_Shield extends Skill {

    public static String NAME = "Solar Shield";

    public Solar_Shield() {
        super();
        setDescription("สร้างโล่แสงให้กับยูนิตพันธมิตรทั้งหมด มอบ Debris XA หน่วยให้กับพวกมัน");
        setActionType("Action");
        setManaCost(0);
        setCooldown(3);
        getSkillMultiplier().put("XA",new SkillMultiplier("8*MATK"));
