...
public class Absolute_Zero extends Skill {

    public static String NAME = "Absolute Zero";

    public Absolute_Zero() {
        super();
        setDescription("เรียกน้ำแข็งขึ้นตรงจุดที่เลือก หากเลือกแช่แข็งยูนิต กักขังมันด้วยกรงพลังชีวิต XA หน่วย");
