...
public class Counter_Slash extends Skill {

    public static String NAME = "Counter Slash";

    public Counter_Slash() {
        super();
        setDescription("บล็อกการโจมตีหนึ่งครั้ง โจมตีระยะประชิดสวนกลับไป สร้างความเสียหายกายภาพ XA หน่วย");
