...
public class Final_Edge extends Skill {

    public static String NAME = "Final Edge";

    public Final_Edge() {
        super();
        setDescription("ใช้งานได้กับอาวุธประเภทดาบเท่านั้น ยกดาบขึ้นสูง แล้วผ่าลงไปตรงหน้า สร้างความเสียหายกายภาพ XA หน่วยเป็นเส้นตรงให้กับยูนิตทั้งหมดในรัศมี XB");
        setActionType("Action");
        setManaCost(0);
        setCooldown(4);
        getSkillMultiplier().put("XA",new SkillMultiplier("3.5*PATK"));
