...
public class Stampede extends Skill {
    ...
    public static String NAME = "Stampede";

    public Stampede() {
        super();
        setDescription("ก้าวอย่างรุนแรง ทุกๆการเคลื่อนไหว 3 เมตรในรอบเทิร์นนี้ สร้างคลื่นจู่โจมศัตรูทั้งหมดในรัศมี 1 เมตร สร้างความเสียหายกายภาพ XA หน่วย");
