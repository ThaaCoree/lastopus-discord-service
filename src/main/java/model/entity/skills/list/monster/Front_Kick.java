...
public class Front_Kick extends Skill {

    public static String NAME = "Front Kick";

    public Front_Kick() {
        super();
        setDescription("โจมตีไปยังเป้าหมายด้วยเท้า สร้างความเสียหายกายภาพ XA หน่วยและมอบสตัน XB รอบเทิร์น");
