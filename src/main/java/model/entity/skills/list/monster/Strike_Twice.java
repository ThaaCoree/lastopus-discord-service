...
public class Strike_Twice extends Skill {

    public static String NAME = "Strike Twice";

    public Strike_Twice() {
        super();
        setDescription("โจมตีระยะใกล้สองครั้ง สร้างความเสียหายกายภาพ XA หน่วยในแต่ละครั้ง");
