...
public class Chain_Lightning extends Skill {

    public static String NAME = "Chain Lightning";

    public Chain_Lightning() {
        super();
        setDescription("ช็อตสายฟ้าไปยังเป้าหมาย สร้างความเสียหายเวท XA หน่วย จากนั้นสายฟ้าชิ่งไปอีก XB เป้าหมาย สร้างความเสียหายเท่ากัน\n" +
                "หากเป้าหมายกำลังเปียก สร้างความเสียหายซ้ำอีกครั้ง");
