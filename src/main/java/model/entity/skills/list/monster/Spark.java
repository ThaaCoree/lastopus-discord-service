...
public class Spark extends Skill {
    ...
    public Spark() {
        super();
        setDescription("ระเบิดเวทมนตร์ออกจากเป้าหมาย สร้างความเสียหายเวท XA หน่วยให้กับเป้าหมายหลักและยูนิตศัตรูทั้งหมดที่อยู่ในรัศมี 3 เมตรรอบตัว\n" +
                "เป้าหมายหลักไม่สามารถหลบหรือบล็อกความเสียหายของสกิลนี้ได้");
        setActionType("Turn");
        setManaCost(0);
        setCooldown(1);
        getSkillMultiplier().put("XA",new SkillMultiplier("3.1*MATK"));
