...
public class Arcane_Shot extends Skill {

    public static String NAME = "Arcane Shot";

    public Arcane_Shot() {
        super();
        setDescription("ยิงลูกธนูเวทมนตร์ใส่เป้าหมาย สร้างความเสียหายเวท XA หน่วย");
        setActionType("Action");
        setManaCost(0);
        setCooldown(1);
        getSkillMultiplier().put("XA",new SkillMultiplier("2.2*RATK"));
