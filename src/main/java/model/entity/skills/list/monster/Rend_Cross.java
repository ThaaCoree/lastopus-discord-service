...
public class Rend_Cross extends Skill {

    public static String NAME = "Rend Cross";

    public Rend_Cross() {
        super();
        setDescription("ใช้งานได้เมื่อมีอาวุธสองข้างเท่านั้น สร้างความเสียหายกายภาพ XA หน่วย การจู่โจมนี้คำนวณ PDEF น้อยลง XB หน่วย");
