...
public class Petrifying_Gaze extends Skill {

    public static String NAME = "Petrifying Gaze";

    public Petrifying_Gaze() {
        super();
        setDescription("จดจ้องไปยังเป้าหมายจนกว่าจะจบรอบเทิร์นนี้ หากเป้าหมายหันมองยูนิตนี้ รับสถานะ Petrified เป็นเวลา XA รอบเทิร์น");
...
//                , 0, 1);
    ...
    public void calculateBehavior(CombatFlow combatFlow, SkillTarget skillTarget) {
        if (!skillTarget.getTarget(0).isEmpty()) {
            ...
            Conditions condition = combatFlow.findCondition("Petrified");
