...
public class Orchestrate extends Skill {

    public static String NAME = "Orchestrate";

    public Orchestrate() {
        super();
        setDescription("หยุดยั้งเป้าหมายในรอบเทิร์นนี้ ข้ามเทิร์นของมัน\n" +
                "เป้าหมายที่ถูกหยุดยั้งสามารถกลับมามีรอบเทิร์นได้ด้วยการถูกยูนิตพันธมิตรช่วยเหลือด้วย Action\n" +
                "ยูนิตพันธมิตรที่ช่วยเหลือเป้าหมายด้วย Action แล้วไม่สามารถใช้งาน Action ในรอบเทิร์นนี้ได้อีกต่อไป");
        setActionType("Turn");
        setManaCost(0);
        setCooldown(1);
    }
