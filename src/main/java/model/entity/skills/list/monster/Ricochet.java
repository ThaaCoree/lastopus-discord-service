...
public class Ricochet extends Skill {
    ...
    public static String NAME = "Ricochet";

    public Ricochet() {
        super();
        setDescription("โจมตีระยะไกลหนึ่งครั้ง หากการตกกระทบครั้งแรกพลาด จะชิ่งเข้าหายูนิตเดิมอีกครั้ง สร้างความเสียหายกายภาพ XA หน่วย");
