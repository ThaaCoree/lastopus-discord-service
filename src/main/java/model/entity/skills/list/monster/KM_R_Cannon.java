...
public class KM_R_Cannon extends Skill {

    public static String NAME = "KM_R_CANNON";

    public KM_R_Cannon() {
        super();
        setDescription("อ้าปากออก ยิงปืนใหญ่จากปาก สร้างความเสียหายกายภาพ XA หน่วยให้กับยูนิตที่โดน การโจมตีนี้มีรัศมี XB เมตร");
