...
public class Thorn_Vines extends Skill {

    public static String NAME = "Thorn Vines";

    public Thorn_Vines() {
        super();
        setDescription("สะบัดเถาวัลย์หนามใส่เป้าหมายที่อยู่ในรัศมี 1 เมตรของตัวเอง สร้างความเสียหายกายภาพ XA หน่วย");
