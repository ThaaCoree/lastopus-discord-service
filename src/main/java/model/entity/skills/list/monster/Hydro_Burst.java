...
public class Hydro_Burst extends Skill {

    public static String NAME = "Hydro Burst";

    public Hydro_Burst() {
        super();
        setDescription("ใช้งานได้โดยเฉพาะหัว Levaria เท่านั้น\n" +
                "ระเบิดน้ำขึ้นจากด้านใต้ในรัศมีสองเมตร สร้างความเสียหายโดยตรงธาตุน้ำ XA หน่วยให้กับยูนิตที่อยู่ในพื้นที่ทั้งหมด ผลักให้ลอยขึ้นตามทิศทางที่เลือก");
