...
public class Aqua_Beam extends Skill {

    public static String NAME = "Aqua Beam";

    public Aqua_Beam() {
        super();
        setDescription("ยิงบีมที่สร้างจากน้ำใส่เป้าหมาย สร้างความเสียหายเวทธาตุน้ำ XA หน่วยพร้อมมอบสถานะ Slip ให้เป็นเวลา XB รอบเทิร์น\n" +
                "Slip : ทุกๆการสั่งเดินหนึ่งครั้งในระหว่างเทิร์น มีโอกาส 40% ที่จะลื่นล้มและจบรอบเทิร์น");
        setActionType("Combine");
        setManaCost(0);
        setCooldown(1);
        getSkillMultiplier().put("XA",new SkillMultiplier("3*MATK"));
