...
public class Elemental_Strike extends Skill {

    public static String NAME = "Elemental Strike";

    public Elemental_Strike() {
        super();
        setDescription("เลือกหนึ่งในสี่ธาตุพื้นฐาน โจมตีธาตุนั้นใส่เป้าหมาย สร้างความเสียหายเวท XA หน่วย");
        ...
        getSkillMultiplier().get("XA").getTags().add(SkillType.EARTH);
