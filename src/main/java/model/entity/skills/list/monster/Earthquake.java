...
public class Earthquake extends Skill {
    ...
    public Earthquake() {
        super();
        setDescription("สร้างแผ่นดินไหวอย่างรุนแรง สร้างความเสียหายกายภาพ XA หน่วยให้กับยูนิตทั้งหมดในสนามห้าครั้ง พร้อมมอบ Tremble ให้พวกมัน 3 รอบเทิร์น");
...
//                , 0, 1);
    ...
    public void calculateBehavior(CombatFlow combatFlow, SkillTarget skillTarget) {
        ...
        Conditions condition = combatFlow.findCondition("Tremble");
        sendActionEvent(combatFlow.getEventBus(),
                ActionEvent.builder(getName(), getUser(), getEnemies(combatFlow))
                        .effect(ActionEffectType.DAMAGE_PHYSICAL, xa, 5)
