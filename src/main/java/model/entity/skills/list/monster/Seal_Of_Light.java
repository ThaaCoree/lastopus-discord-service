...
public class Seal_Of_Light extends Skill {

    public static String NAME = "Seal of Light";

    public Seal_Of_Light() {
        super();
        setDescription("Imprison ยูนิตเป้าหมายด้วยกรงพลังชีวิตไม่จำกัดเป็นระยะเวลา XA รอบเทิร์น");
