...
public class Seen_Strike extends Skill {

    public static String NAME = "Seen Strike";

    public Seen_Strike() {
        super();
        setDescription("มองไปยังอนาคต จากนั้นจู่โจมสองครั้งโดยอิงจากสิ่งที่เห็น การจู่โจมนี้ไม่สามารถถูกหลบได้ สร้างความเสียหายกายภาพครั้งละ XA หน่วย");
