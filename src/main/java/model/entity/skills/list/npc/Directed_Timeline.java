...
public class Directed_Timeline extends Skill {

    public static String NAME = "Directed Timeline";

    public Directed_Timeline() {
        super();
        setDescription("กระทำสิ่งเล็กน้อยที่เปลี่ยนแปลงอนาคต ทำให้การกระทำที่กำลังเกิดขึ้นของหนึ่งยูนิตไร้ผลหากเป็นไปได้");
