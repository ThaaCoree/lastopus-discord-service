...
public class Air_Crush extends Skill {

    public static String NAME = "Air Crush";

    public Air_Crush() {
        super();
        setDescription("สร้างความเสียหายเวท XA หน่วยให้กับเป้าหมาย XB ครั้ง ในแต่ละครั้งสามารถเลือกเป้าหมายใหม่ได้");
