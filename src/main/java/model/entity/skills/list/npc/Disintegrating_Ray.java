...
public class Disintegrating_Ray extends Skill {

    public static String NAME = "Disintegrating Ray";

    public Disintegrating_Ray() {
        super();
        setDescription("ยิงลำแสงใส่เป้าหมาย สร้างความเสียหายเวท XA หน่วยโดยทะลุผ่าน Debris และหลบหลีกไม่ได้");
