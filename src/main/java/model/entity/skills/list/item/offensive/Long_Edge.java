...
public class Long_Edge extends Skill {

    public static String NAME = "Long Edge";

    public Long_Edge() {
        super();
        setDescription("เมื่อโจมตีระยะใกล้ สามารถทำให้การจู่โจมนั้นเป็นแบบเทิร์นแล้วเพิ่มระยะการโจมตีให้ยาว XA เมตรกว้างสามเมตรได้");
