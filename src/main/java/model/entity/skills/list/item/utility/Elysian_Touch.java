...
public class Elysian_Touch extends Skill {

    public static String NAME = "Elysian Touch";

    public Elysian_Touch() {
        super();
        setDescription("สัมผัสกับเป้าหมายแล้วมอบสถานะ Sleep XA รอบเทิร์น");
...
//                , 0, 1);
    ...
    public void calculateBehavior(CombatFlow combatFlow, SkillTarget skillTarget) {
        if (!skillTarget.getTarget(0).isEmpty()) {
            ...
            Conditions condition = combatFlow.getDatabase().getAllConditionMap().get("Sleep");
