...
public class Thunder_Call extends Skill {

    public static String NAME = "Thunder Call";

    public Thunder_Call() {
        super();
        setDescription("ใช้งานได้เมื่อจู่โจม เรียกสายฟ้าในพื้นที่เป้าหมาย สร้างความเสียหายกายภาพ XA หน่วย");
        setActionType("-");
        setManaCost(0);
        setCooldown(0);
