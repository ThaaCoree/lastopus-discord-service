...
public class Blink_Slash extends Skill {

    public static String NAME = "Blink Slash";

    public Blink_Slash() {
        super();
        setDescription("เมื่อโจมตีผนวกความเร็ว จะโจมตีศัตรูทั้งหมดที่อยู่ในเส้นทาง และการโจมตีผนวกความเร็วจะสร้างความเสียหายเพิ่มขึ้นด้วย");
