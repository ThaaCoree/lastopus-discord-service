...
public class Innate_Stab extends Skill {

    public static String NAME = "Innate Stab";

    public Innate_Stab() {
        super();
        setDescription("เมื่อจู่โจมด้วยมีดสำเร็จ จู่โจมด้วยมีดได้อีกชุด\n" +
                "ความสามารถนี้ทำงานได้ไม่เกิน XA ครั้งต่อรอบเทิร์น");
