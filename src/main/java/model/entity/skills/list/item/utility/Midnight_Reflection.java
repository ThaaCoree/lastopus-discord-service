...
public class Midnight_Reflection extends Skill {

    public static String NAME = "Midnight Reflection";

    public Midnight_Reflection() {
        super();
        setDescription("เพิ่มจำนวนโปรเจ็กไทล์ในสนามขึ้นอีก XA อัน");
