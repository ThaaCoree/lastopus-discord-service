...
public class Backtrack extends Skill {

    public static String NAME = "Backtrack";

    public Backtrack() {
        super();
        setDescription("เมื่อจะได้รับความเสียหายที่มากกว่า XA แล้วทำให้หมดสติ ยกเลิกความเสียหายนั้น\n" +
