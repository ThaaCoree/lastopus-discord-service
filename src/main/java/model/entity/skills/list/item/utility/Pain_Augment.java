...
public class Pain_Augment extends Skill implements SkillWithCondition {

    public static String NAME = "Pain Augment";

    public Pain_Augment() {
        super();
        setDescription("ลดพลังชีวิตที่เหลืออยู่ XA หน่วย เพิ่ม ATK XB เป็นเวลา XC รอบเทิร์น");
        ...
        getSkillMultiplier().put("XB",new SkillMultiplier("0.21*(1+BuffAMP)"));
...
//                , 0, 1);
    ...
    public void calculateBehavior(CombatFlow combatFlow, SkillTarget skillTarget) {
        ...
        Conditions condition = combatFlow.getDatabase().getAllConditionMap().get("Pain Augmented");
    ...
    public void refreshCondition(CombatFlow combatFlow) {
        Conditions condition = new Conditions("Pain Augmented");
