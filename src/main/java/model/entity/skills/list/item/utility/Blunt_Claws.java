...
public class Blunt_Claws extends Skill {

    public static String NAME = "Blunt Claws";

    public Blunt_Claws() {
        super();
        setDescription("โจมตีระยะใกล้ สร้างความเสียหายกายภาพ XA หน่วย ทำให้เป้าหมายได้รับ Mini Stun XA รอบเทิร์น");
        setActionType("Combine");
        setManaCost(0);
        setCooldown(0);
        getSkillMultiplier().put("XA",new SkillMultiplier("0.5*PATK"));
