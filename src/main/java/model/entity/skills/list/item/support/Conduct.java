...
public class Conduct extends Skill {

    public static String NAME = "Conduct";

    public Conduct() {
        super();
        setDescription("สามารถใช้งาน Combined Action เพื่อทำให้หนึ่งยูนิตที่ได้ยินออก Action ในทันทีได้\n" +
