...
public class Hydro_Beam extends Skill {

    public static String NAME = "Hydro Beam";

    public Hydro_Beam() {
        super();
        setDescription("ใช้งานได้โดยเฉพาะหัว Levanis เท่านั้น\n" +
                "ยิงน้ำเป็นเส้นตรงด้วยความเร็วสูงไปยัง XB เป้าหมาย สร้างความเสียหายเวทธาตุน้ำ XA หน่วย");
