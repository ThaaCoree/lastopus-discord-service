...
public class Fan_The_Flames extends Skill {

    public static String NAME = "Fan the Flames";

    public Fan_The_Flames() {
        super();
        setDescription("เรียกและกระจายเพลิงออกไปด้านหน้า 4 เมตร กว้างออกด้านละ 1 เมตร สร้างความเสียหายเวท XA หน่วย");
