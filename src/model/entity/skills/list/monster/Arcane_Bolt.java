...
public class Arcane_Bolt extends Skill {

    public static String NAME = "Arcane Bolt";

    public Arcane_Bolt() {
        super();
        setDescription("ยิงกระสุนมนตรา XA ลูกไปที่เป้าหมาย สร้างความเสียหายกายภาพลูกละ XB หน่วย");
        ...
        getSkillMultiplier().put("XB",new SkillMultiplier("1*MATK"));
