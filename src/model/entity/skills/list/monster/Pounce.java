...
public class Pounce extends Skill {
    ...
    public Pounce() {
        super();
        setDescription("กระโดดเข้าใส่เป้าหมายระยะทางสูงสุด XA เมตรจนเข้าประชิดพร้อมโจมตีเป้าหมาย สร้างความเสียหายกายภาพ XB หน่วย");
        ...
        getSkillMultiplier().put("XB",new SkillMultiplier("0.8*PATK"));
