...
public class Glyph_Rearrangement extends Skill {

    public static String NAME = "Glyph Rearrangement";

    public Glyph_Rearrangement() {
        super();
        setDescription("เมื่อหลักมนตรากำลังจะถูกจู่โจม ถอดองค์ประกอบของมันและขยับศิลาให้หลบออกจากวิธีจู่โจม\n" +
                "จากนั้นประกอบหลักใหม่ หลักมนตรายิงลำแสงไปที่ผู้จู่โจม XA ครั้ง สร้างความเสียหายเวทธาตุแสง XB หน่วย การจู่โจมนี้ไม่สามารถถูกหลบได้ สุดท้าย หมุนหลักหนึ่งครั้งให้กลับมาทำงานแบบเดิม");
