...
public class Deep_Wound extends Skill {
    ...
    public static String NAME = "Deep Wound";

    public Deep_Wound() {
        super();
        setDescription("สร้างความเสียหายกายภาพระยะใกล้ให้กับเป้าหมาย XA หน่วย มอบสถานะ Deep Wound ให้กับมันเป็นเวลา XB เทิร์น");
...
//                , 0, 1);
    ...
    public void calculateBehavior(CombatFlow combatFlow, SkillTarget skillTarget) {
        if (!skillTarget.getTarget(0).isEmpty()) {
            ...
            Conditions condition = combatFlow.getDatabase().getAllConditionMap().get("Deep Wound");
