...
public class Rapid_Heal extends Skill {

    public static String NAME = "Rapid Heal";

    public Rapid_Heal() {
        super();
        setDescription("ฮีลให้กับเป้าหมาย XA ครั้ง ครั้งละ XB หน่วย");
        ...
        if (!skillTarget.getTarget(0).isEmpty()) {
            ...
            sendActionEvent(combatFlow.getEventBus(),
                    ActionEvent.builder(getName(), getUser(), combatFlow.findUnit(skillTarget.getTarget(0)))
                            .effect(ActionEffectType.HEALTH_RECOVER, xb, (int) xa)
