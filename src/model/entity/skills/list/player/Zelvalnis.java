...
public class Zelvalnis extends Skill implements SkillWithCondition {

    public static String NAME = "Zelval'nis";

    public Zelvalnis() {
        super();
        setDescription("สยายปีกออกมอบสถานะ Vah'ris ให้กับตัวเองเป็นเวลา XB รอบเทิร์น และเพิ่มความเสียหายคริติคอลที่ทำได้มากขึ้น XA\n" +
                "หากโจมตีใส่เป้าหมายที่อยู่ในสถานะ Ka´rahn การโจมตีจะสามารถเปลี่ยนทิศทางเข้าหาเป้าหมายได้หนึ่งครั้ง");
...
//                , 0, 1);
    ...
    public void calculateBehavior(CombatFlow combatFlow, SkillTarget skillTarget) {
        ...
        Conditions condition = combatFlow.getDatabase().getAllConditionMap().get("Vah'ris");
    ...
    public void refreshCondition(CombatFlow combatFlow) {
        ...
        Conditions condition = new Conditions("Vah'ris");
        condition.getStatModifiers(StatType.CRITDAMAGE).setGlobalMult(getSkillMultiplier().get("XA").getResult());
