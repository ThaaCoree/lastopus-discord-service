...
public class Volcanica extends Skill {

    public static String NAME = "Volcanica";

    public Volcanica() {
        super();
        setDescription("เมื่อสวมใส่อุปกรณ์ Volcanic อย่างน้อย XA ส่วน ลดความเสียหายไฟที่รับเหลือหนึ่งในสิบส่วน");
