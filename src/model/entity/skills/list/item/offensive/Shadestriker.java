...
public class Shadestriker extends Skill {

    public static String NAME = "Shadestriker";

    public Shadestriker() {
        super();
        setDescription("เมื่อสวมใส่อุปกรณ์ Shadewalker อย่างน้อย XA ส่วน\n" +
                "การโจมตีจากที่มืดสนิทจะสร้างความเสียหายเพิ่มขึ้น XB");
