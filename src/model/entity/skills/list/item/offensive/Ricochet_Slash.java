...
public class Ricochet_Slash extends Skill {

    public static String NAME = "Ricochet Slash";

    public Ricochet_Slash() {
        super();
        setDescription("เมื่อจู่โจมด้วยอาวุธแล้วตกกระทบ จู่โจมอีกหนึ่งเป้าหมายในรัศมี XA เมตรของเป้าหมายแรก");
