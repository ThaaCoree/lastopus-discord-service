...
public class Spell_Infusion extends Skill {

    public static String NAME = "Spell Infusion";

    public Spell_Infusion() {
        super();
        setDescription("ฟื้นฟู MP XA หน่วยให้กับยูนิตที่เลือก");
        ...
        if (!skillTarget.getTarget(0).isEmpty()) {
            ...
            sendActionEvent(combatFlow.getEventBus(),
                    ActionEvent.builder(getName(), getUser(), combatFlow.findUnit(skillTarget.getTarget(0)))
                            .effect(ActionEffectType.MANA_RECOVER, xa, 1)
